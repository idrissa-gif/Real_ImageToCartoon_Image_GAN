            ...
            <div className="app">
                <Container fluid style={{"display": this.state.generationStatus === 0 ? "block" : "none"}}>
                    <Row className="margin">
                        <Col/>
                            <Col xs="12">
                                <h1 style={{"marginBottom": "20px", textAlign: "center"}}>Real Image to Cartoon Image Using GAN <a href="https://github.com/idrissa-gif/Real_ImageToCartoon_Image_GAN" style={{"fontSize": "12px"}}>View Source Code</a></h1>
                            </Col>
                        <Col/>
                    </Row>
                    <Row className="margin">
                    ...
                    <Container fluid>
                        ...
                        <Row className="margin">
                            ...
                            <Col xs="12" md="12" lg="12" xl="10" style={{textAlign: "center", margin: "20px"}}>
                                <p>If it looks good, you could <a href="https://github.com/idrissa-gif/Real_ImageToCartoon_Image_GAN">give Real Image To Cartoon Image  using GAN a star <span role="img" aria-label="star">🌟</span> on Github</a>.</p>
                                <p>Real Image To Cartoon Image using GAN uses the trained model from AnimeGAN. If you are interested in how the TensorFlow version of AnimeGAN works, <a href="https://github.com/TachibanaYoshino/AnimeGAN">click here</a></p>
